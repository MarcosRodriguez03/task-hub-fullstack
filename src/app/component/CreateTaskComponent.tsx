    ...
    return (
        <div className='  absolute top-1/2 -translate-y-1/2 z-[100] justify-center  flex w-full bg-black bg-opacity-80 h-screen  items-center'>
            <div className='flex flex-col w-full md:w-[604px] bg-[#181818]  mx-[10px] border-[#808080] border  rounded-[10px] p-[20px] lg:p-[30px]  h-fit  relative overflow-auto'>
                ...
                <div className='w-auto h-[30px] rounded-[10px] mb-[25px] bg-[#282828] border-b border-[#808080]'>
                    <input
                        maxLength={20}
                        defaultValue={taskObj && taskObj.taskName}
                        id={id}
                        onChange={(e) => { setUseTaskName(e.target.value); }}
                        type="text" placeholder='Task name' className='  h-[30px] placeholder:text-[#808080] text-[#808080] w-full rounded-[10px] border border-transparent bg-transparent' />
                </div>
                ...
                <div className='w-auto h-[30px] rounded-[10px] mb-[25px] bg-[#282828] border-b border-[#808080]'>
                    <input
                        ...
                        type="text" placeholder='Description' className='h-[30px] placeholder:text-[#808080] text-[#808080] w-full rounded-[10px] border border-transparent bg-transparent' />
                </div>
                ...
                <div className='w-auto h-[30px] rounded-[10px] mb-[25px] bg-[#282828] border-b border-[#808080]'>
                    <input
                        ...
                        type="text" placeholder='Est. task duration' className='h-[30px] placeholder:text-[#808080] text-[#808080] w-full rounded-[10px] border border-transparent bg-transparent' />
                </div>
                ...
                <select
                    ...
                    className='bg-[#282828] text-[#808080] border-[#808080] lg:w-[180px] w-full rounded-[10px] mb-[25px]'
                >
                ...
                <select
                    ...
                    className=' bg-[#282828] text-[#808080] border-[#808080] lg:w-[180px] text-[16px]  w-full   rounded-[10px] mb-[25px]'>
