  ...
  return (
    <div>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-50">
        <div className=" bg-[#181818] border-[#808080] border-[1px] mx-[10px] w-full lg:w-[941px] p-[30px] h-[80vh] lg:h-[584px] rounded-[10px] shadow-md overflow-auto">
          ...
          <div className="grid lg:grid-cols-12">
            ...
            <div className="order-1 lg:order-2 lg:col-span-4 grid justify-center lg:justify-end">
              <div>
                ...
                <button className="mt-[25px] lg:mt-[15px] bg-[#282828] border-[1px] border-[#808080] h-[50px] w-[250px] text-[24px] font-semibold text-white rounded-[10px]">
                  Upload Photo
                </button>
