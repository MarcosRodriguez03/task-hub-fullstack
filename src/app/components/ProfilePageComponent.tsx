...
const ProfilePageComponent = (prop: {pageProfile: (input: string) => void}) => {
    ...
    return (
        <div className='w-full lg:bg-black lg:bg-opacity-80 h-screen absolute right-0 lg:z-40' >
            ...
            <div className=' w-full lg:w-[604px]  absolute right-0 z-20 top-[80px] bottom-[80px] lg:bottom-0  lg:border-l lg:border-[#808080] bg-[#181818] p-[20px] lg:p-[30px] overflow-auto'>
                ...
                <div className='flex justify-center flex-col items-center mt-[25px]'>
                    ...
                    <p className='text-[24px] font-bold text-[#B8B8B8] mt-1'>TylerAcc233</p>
                    <div className='bg-[#282828] w-full mx-[20px] lg:mx-[30px] h-[257px] lg:h-[283px] rounded-[10px] my-6 overflow-y-auto p-[20px]'>
                        <p className='text-[#B8B8B8] text-[24px] font-semibold'>Contact</p>
                        <p className='text-white text-[20px] font-medium'>free.99@gmail.com</p>
                        <p className='text-[#B8B8B8] text-[24px] font-semibold mt-6'>Bio</p>
                        <p className='text-white text-[20px] font-medium'>descriptions</p>
                    </div>
                    <div className='grid justify-center'>
                        <button className='bg-[#5C5C5C] text-[24px] text-white font-semibold h-[49px] w-[193px] rounded-[10px]'>Edit</button>
                    </div>
