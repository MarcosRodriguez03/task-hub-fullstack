...
const ProfilePageComponent = () => {
    ...
    return (
        <div className='w-full lg:bg-black lg:bg-opacity-80 h-screen  absolute right-0  lg:z-10' >
            ...
            <span className='hidden lg:flex items-center bg-[#181818] border-l border-[#808080] w-[604px] absolute right-0 px-[30px] pb-[20px] pt-[30px] '>
                <button className='me-[15px] w-[50px] h-[50px] bg-[#212020] hover:bg-[#3a3838] active:bg-[#4a4848] rounded-[10px] flex items-center justify-center'>
