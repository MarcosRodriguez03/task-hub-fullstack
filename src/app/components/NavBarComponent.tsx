...
import mobilenotif from '@/assets/mobilenotifs.png';
...
const NavBarComponent = (prop: { title: string }) => {
  return (
    <div>
      ...
      <div className="h-[70px] bg-[#181818] lg:px-[30px] w-full bottom-0 fixed lg:static border-t-[1px] lg:border-t-0 lg:border-b-2 border-[#525252]">
        ...
        <div className="flex lg:hidden justify-evenly h-full">
